...
export class UtilisateursAPI extends Core {
     ...
     */
    paginateMoiEmails(page?: number, perPage?: number): AsyncGenerator<PaginateMoiEmails200Response>
    {
        const pathVariable = {  };
     ...
     * @param perPage Nombre de résultats demandé
     */
    paginateMoiEmails1(page?: number, perPage?: number): AsyncGenerator<PaginateMoiEmails200Response>
    {
        const pathVariable = {  };
        return this.autoPagingIterator({
            method: 'GET',
