    ...
    ) : Promise<AxiosResponse<ERP>>
    {
        ...
        return this.request({
            ...
            transformResponse: [(data) => {
                ...
                if (parsedData && parsedData.descriptif_technique.analyse_risque?.autres_activites) {
                    parsedData.descriptif_technique.analyse_risque.autres_activites = new Set(parsedData.descriptif_technique.analyse_risque.autres_activites);
                }
