...
/**
 * Interface permettant à une application externe (ex: angular-oauth2-oidc)
 * de fournir les access tokens au SDK. Quand un TokenProvider est défini,
 * le SDK délègue entièrement la gestion des tokens (obtention + refresh)
 * au provider et désactive sa propre logique de refresh interne.
 */
