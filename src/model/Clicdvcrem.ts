...
export enum ActivitePrincipaleEnum {
    ...
    PE_2_2___HEBERGEMENT_DE_MINEURS_EN_DEHORS_DE_LEURS_FAMILLES_LE_SEUIL_DE_LEFFECTIF_EST_FIXE_A_7_MINEURS = 'PE 2 §2 - Hébergement de mineurs en dehors de leurs familles, le seuil de l\'effectif est fixé à 7 mineurs',
